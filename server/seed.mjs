...
export function createSeedData() {
  ...
  return {
    ...
    bookings: [
      ...
      { id: 'bok_zhou_001', consultationId: 'con_zhou_001', patientId: 'usr_patient_zhou', doctorId: 'usr_doctor_demo', scheduleId: 'sch_zhang_1', department: '神经内科', campus: '滨江院区', appointmentAt: iso(21), status: 'confirmed', createdAt: iso(-25) },
    ],
    dispositions: [],
    followups: [
