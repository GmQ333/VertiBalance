...
const coveredRoutes = new Set([
  ...
  'GET /notifications', 'PATCH /notifications/:id/read', 'PATCH /notifications/read-all', 'POST /feedback', 'GET /support-requests', 'PATCH /auth/profile', 'PATCH /auth/password',
  ...
  'GET /uploads/:id/download', 'GET /uploads/:id/preview', 'DELETE /uploads/:id', 'GET /doctor/workbench', 'GET /doctor/patients/:id',
  'POST /doctor/patients/:id/ai-analysis', 'POST /doctor/dispositions', 'POST /doctor/followups',
