...
export const api = {
  ...
  changePassword: (body) => apiRequest('/auth/password', { method: 'PATCH', body }),
  ...
  doctorPatients: () => apiRequest('/doctor/patients'),
  ...
  doctorQuestion: (id, question, analysis, history = []) => apiRequest(`/doctor/patients/${id}/ai-question`, { method: 'POST', body: { question, analysis, history } }),
